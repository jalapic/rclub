...
# or you can just look at if the beta's are different from zero
# lm approach
tmp3 <- lm(Beta ~ 1,data=RIKZ)

# or use t-test to see if they are different from zero
t.test(Beta) #but this is technically wrong

##tmp3 basically tells you that there is a relationship between NAP and Species Richness
